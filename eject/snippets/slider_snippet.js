...
const toggleActiveClass = (i, list) => {
    ...
    const offerName = document.querySelector('.intro-offer__name');
    const activeBlock = $('.intro-img__title').find($('.active')).text();
    offerName.textContent = activeBlock;
};


const imagesPag = $('.intro-img__btn button');
const imagesPag2 = $('.intro-img__btn-none button');
const images = $('.intro-img__img img');
const imagesTitle = $('.intro-img__title h2');
const imagesAbout = $('.sec-about div');
...
;(function (factory) {
        ...
        function Slick(element, settings) {
            ...
            imagesPag.each(function (i) {
                $(this).click(() => {
                    ...
                    toggleActiveClass(i, imagesTitle);
                    toggleActiveClass(i, imagesAbout);
                    _.currentSlide = i;
                    _.setCSS(_.getLeft(_.currentSlide));
                });
            });
            imagesPag2.each(function (i) {
                $(this).click(() => {
                    toggleActiveClass(i, imagesPag2);
                    toggleActiveClass(i, images);
                    toggleActiveClass(i, imagesTitle);
                    toggleActiveClass(i, imagesAbout);
                    _.currentSlide = i;
    ...
    Slick.prototype.swipeEnd = function (event) {
        ...
        toggleActiveClass(_.currentSlide, imagesPag);
        toggleActiveClass(_.currentSlide, imagesPag2);
        toggleActiveClass(_.currentSlide, images);
        toggleActiveClass(_.currentSlide, imagesTitle);
        toggleActiveClass(_.currentSlide, imagesAbout);
...
const sliderHome = document.querySelector('.intro-img__img-start');

if (sliderHome) {
    $('.intro-img__img-start').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        fade: false,
...
const promotionList = document.querySelector('.promotion__list');
...
const element = document.querySelector('#content4');
...
const observer = new MutationObserver((mutationsList) => {
    ...
    if (mutation.type === 'attributes' && mutation.attributeName === 'style') {
        ...
        const sliderEnd = document.querySelector('.intro-img__img-end');

        if (sliderEnd) {
            //** Slider */
            $('.intro-img__img-end').slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                arrows: false,
                fade: false,
            ...
            const offerName = document.querySelector('.intro-offer__name');
            const initText = $('.intro-img__title').find($('h2')).first().text();
            offerName.textContent = initText;
        }
        observer.disconnect();
    }
